            ...
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navigation">
                    <ul class="navbar-nav navbar-nav-hover mx-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pushnotification.index') }}" id="nav-hov">
                            Send Notification
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="card-title" style="color:rgba(0, 0, 0, 0.5)">Notification List</h4>
                                <p class="card-description">  Notification New List </p>
                            </div>
