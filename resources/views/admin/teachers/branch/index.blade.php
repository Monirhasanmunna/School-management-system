                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h4 class="card-title" style="color:rgba(0, 0, 0, 0.5)">Branch List</h4>
                                <p class="card-description"> Branch new List </p>
                            </div>
                            <button type="button" class="btn btn-primary mr-2" style="width: 155px;height: 34px;"
                                data-toggle="modal" data-target="#exampleModal">Create Branch
                            </button>
                        </div>
                        <div class="content-wrapper text-primary">
                            <table id="customTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <td>{{++$i}}</td>
                                    <td>{{$branch->title}}</td>
                                    <td><label class="badge badge-info">{{ ($branch->status == 1) ? "Active" : "Not-Active" }}</label></td>
                                    <td><a class="badge badge-success" href="{{route('branch.edit',['id'=>$branch->id])}}">Edit</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
